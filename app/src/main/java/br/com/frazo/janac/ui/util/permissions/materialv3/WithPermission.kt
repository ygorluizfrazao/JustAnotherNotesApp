package br.com.frazo.janac.ui.util.permissions.materialv3
...
import br.com.frazo.janac.ui.util.permissions.base.PermissionsAskingStrategyInteraction
...
fun createPermissionDialogProperties(
    ...
    onGrantButtonClicked: (state: PermissionFlowStateEnum, permissionsStatus: Map<String, Boolean>) -> Unit = { _, _ -> Unit },
    onDenyButtonClicked: (state: PermissionFlowStateEnum, permissionsStatus: Map<String, Boolean>) -> Unit = { _, _ -> Unit }
